...
namespace EvelentWalker.Rendering
{
    public class DXManager
    {
        ...
        public bool Init(DXForm form, bool autostart = true)
        {
            ...
            try
            {
                ...
                if (!success)
                {
                    var msg = "EvelentWalker was unable to initialise the graphics device. Please ensure your system meets the minimum requirements and that your graphics drivers and DirectX are up to date.";
                    if (exc != null)
                    {
