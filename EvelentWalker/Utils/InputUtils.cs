...
namespace EvelentWalker
{
    ...
    public class InputManager
    {
        ...
        public void Init()
        {
            //Gamepad/controller support has been removed - keep the controller
            //uninitialised so xbenable stays false everywhere.
            xbcontroller = null;
        }
        ...
        public void Update()
        {
            ...
            xbenable = false; //gamepad/controller support removed
