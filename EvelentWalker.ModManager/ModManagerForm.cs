...
namespace EvelentWalker.ModManager
{
    public partial class ModManagerForm : Form
    {
        ...
        private void Initialise()
        {
            void initFail(string msg, string title)
            {
                Invoke(new Action(() =>
                {
                    var msgex = "EvelentWalker Mod Manager will now exit.";
            ...
            Task.Run(() =>
            {
                ...
                if (Settings.FileExists == false)
                {
                    ...
                    var msg2 = "Please make sure you have installed EvelentWalker Mod Manager correctly.";
